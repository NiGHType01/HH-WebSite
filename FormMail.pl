...
BEGIN
{
  ...
  $postmaster        = 'postmaster@hebbleharlequins.co.uk';
  @referers          = qw(hebbleharlequins.co.uk www.hebbleharlequins.co.uk);
  @allow_mail_to     = qw(postmaster@hebbleharlequins.co.uk);
  @recipients        = ();
  %recipient_alias   = ();
